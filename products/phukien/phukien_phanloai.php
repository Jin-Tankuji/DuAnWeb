        ...
        <header>
            ...
            <div class="menu" style="padding-right: 8px; font-family: Times New Roman">
                ...
                <li><a href="./phukien.php">Phụ kiện</a>
                    <ul class="menu6">
                        <li><a href="./phukien_phanloai.php?phanloai=16">Airpods</a></li>
                        <li><a href="./phukien_phanloai.php?phanloai=17">Airtags</a></li>
                        <li><a href="./phukien_phanloai.php?phanloai=22">Magsafe</a></li>
                        <li><a href="./phukien_phanloai.php?phanloai=18">Case</a></li>
                ...
                <div class="row">
                    ...
                    <div class="products">
                        <?php
                            ...
                            $current_phanloai = !empty($_GET['phanloai']) ? $_GET['phanloai'] : 16;
