...
<html lang="en">
    <head>
        ...
        <title>Loa Apple chính hãng</title>
        <style>
            .cartPayment{
                display: flex;
                flex-direction: row;
    ...
    <body>
        <header>
            ...
            <div class="menu" style="padding-right: 8px; font-family: Times New Roman">
                ...
                <li><a href="./homepod.php">HomePod</a>
                    <ul class="menu5">
                        <li><a href="./homepod_phanloai.php?phanloai=14">HomePod Mini</a></li>
                        <li><a href="./homepod_phanloai.php?phanloai=15">HomePod</a></li>
                    </ul>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="products">
                        <?php
                            ...
                            $current_phanloai = !empty($_GET['phanloai']) ? $_GET['phanloai'] : 14;
