                ...
                <div class="row">
                    ...
                    <div class="products">
                        <?php
                            ...
                            {
                                $products = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE id_mathang = 5 ".$orderCondition." LIMIT ".$item_per_page." OFFSET ".$offset);
                                $total_item = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE id_mathang = 5");
                            }
