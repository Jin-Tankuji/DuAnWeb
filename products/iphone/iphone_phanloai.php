...
<html lang="en">
    <head>
        ...
        <title>Điện thoại iPhone chính hãng chính hãng</title>
        <style>
            .cartPayment{
                display: flex;
                flex-direction: row;
        ...
        <header>
            ...
            <div class="menu" style="padding-right: 5px; font-family: Times New Roman">
                <li><a href="./iphone.php">iPhone</a>
                    <ul class="menu1">
                        <li><a href="./iphone_phanloai.php?phanloai=1">iPhone 14</a></li>
                        <li><a href="./iphone_phanloai.php?phanloai=2">iPhone 13</a></li>
                        <li><a href="./iphone_phanloai.php?phanloai=3">iPhone 12</a></li>
                        <li><a href="./iphone_phanloai.php?phanloai=4">iPhone 11</a></li>
                        <li><a href="./iphone_phanloai.php?phanloai=5">iPhone SE</a></li>
                    </ul>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="products">
                        <?php
                            ...
                            $current_phanloai = isset($_GET['phanloai']) ? $_GET['phanloai'] : 1;
                            $wherePL = "";
                            if ($current_phanloai)
                            {
                                $wherePL = "WHERE id_phanloai=".$current_phanloai;
                            }
                            if ($search) 
                            {
                                $products = mysqli_query($conn, "SELECT * FROM tb_sanpham ".$where." ".$orderCondition." LIMIT ".$item_per_page." OFFSET ".$offset);
                                $total_item = mysqli_query($conn, "SELECT * FROM tb_sanpham ".$where);
                            }
                            else
                            {
                                $products = mysqli_query($conn, "SELECT * FROM tb_sanpham ".$wherePL." ".$orderCondition." LIMIT ".$item_per_page." OFFSET ".$offset);
                                $total_item = mysqli_query($conn, "SELECT * FROM tb_sanpham ".$wherePL);
                            }
