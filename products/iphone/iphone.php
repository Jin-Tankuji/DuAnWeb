...
<!--         <link rel="stylesheet" href="../detail.css">-->
        <title>Điện thoại iPhone chính hãng chính hãng</title>
            <!-- giao diện nút thanh toán và tổng giá -->
        <style>
            .cartPayment{
                display: flex;
                flex-direction: row;
                ...
                <div class="row">
                    ...
                    <div class="products">
                        <?php
                            ...
                            {
                                $products = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE id_mathang = 1 ".$orderCondition." LIMIT ".$item_per_page." OFFSET ".$offset);
                                $total_item = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE id_mathang = 1");
                            }
