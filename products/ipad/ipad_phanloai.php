...
<html lang="en">
    <head>
        ...
        <title>Máy tính bảng Apple iPad chính hãng</title>
        <style>
            .cartPayment{
                display: flex;
                flex-direction: row;
        ...
        <header>
            ...
            <div class="menu" style="padding-right: 8px; font-family: Times New Roman">
                ...
                <li><a href="../mac/mac.php">Mac</a>
                    <ul class="menu2">
                        <li><a href="../mac/mac_phanloai.php?phanloai=6">Macbook Air</a></li>
                        <li><a href="../mac/mac_phanloai.php?phanloai=7">Macbook Pro</a></li>
                        <li><a href="../mac/mac_phanloai.php?phanloai=20">iMac</a></li>
                        <li><a href="../mac/mac_phanloai.php?phanloai=21">Mac Mini</a></li>
                    </ul>
                </li>
                <li><a href="./ipad.php">iPad</a>
                    <ul class="menu3">
                        <li><a href="./ipad_phanloai.php?phanloai=8">iPad Gen</a></li>
                        <li><a href="./ipad_phanloai.php?phanloai=9">iPad Pro</a></li>
                        <li><a href="./ipad_phanloai.php?phanloai=10">iPad Air</a></li>
                    </ul>
                </li>
                ...
                <li><a href="../phukien/phukien.php">Phụ kiện</a>
                    <ul class="menu6">
                        ...
                        <li><a href="../phukien_phanloai.php?phanloai=19">Keyboard</a></li>
                    </ul>
                </li>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                            ...
                            $current_phanloai = !empty($_GET['phanloai']) ? $_GET['phanloai'] : 8;
                            $offset = ($current_page - 1) * $item_per_page;
                            if ($search)
                            {
                                $products = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE tensanpham LIKE '%" .$search. "%' ORDER BY id_sanpham ASC LIMIT ".$item_per_page." OFFSET ".$offset);
                                $total_item = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE tensanpham LIKE '%" .$search. "%'");
                            }
                            else
                            {
                                $products = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE id_phanloai = '$current_phanloai' ORDER BY id_sanpham ASC LIMIT ".$item_per_page." OFFSET ".$offset);
                                $total_item = mysqli_query($conn, "SELECT * FROM tb_sanpham WHERE id_phanloai = '$current_phanloai'");
                            }
                            ...
                            while($row = mysqli_fetch_assoc($products)) {
                                ...
                                echo "<div class='product-name' style='padding: 0'>";
                                echo "<h3>" . $row['tensanpham'] . "</h3>";
                                echo "</div>";
                                echo "<div class='product-price' style='padding: 0'>";
