...
<html lang="en">
    <head>
        ...
        <title>Đồng hồ Apple Watch chính hãng</title>
        <style>
            .cartPayment{
                display: flex;
                flex-direction: row;
        ...
        <header>
            ...
            <div class="menu" style="padding-right: 8px; font-family: Times New Roman">
                ...
                <li><a href="./watch.php">Watch</a>
                    <ul class="menu4">
                        <li><a href="./watch_phanloai.php?phanloai=11">Apple Watch Series 7</a></li>
                        <li><a href="./watch_phanloai.php?phanloai=12">Apple Watch Series 8</a></li>
                        <li><a href="./watch_phanloai.php?phanloai=13">Apple Watch Ultra</a></li>
                    </ul>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="products">
                        <?php
                            ...
                            $current_phanloai = !empty($_GET['phanloai']) ? $_GET['phanloai'] : 11;
